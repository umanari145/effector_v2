...
class CustomerFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'kana' => 'required|string|max:100|regex:/^[ア-ヲァ-ォャ-ヮヴ　\s]+$/u',
            'email' => 'required|email|max:255',
            'tel' => 'required|regex:/^[0-9\-]+$/|min:10|max:15',
            'zip' => 'required|regex:/^\d{3}-\d{4}$/|size:8',
        ...
        if (!$this->input('same_as_customer')) {
            ...
            $rules['shipping_kana'] = 'required|string|max:100|regex:/^[ア-ヲァ-ォャ-ヮヴ　\s]+$/u';
            $rules['shipping_tel'] = 'required|regex:/^[0-9\-]+$/|min:10|max:15';
            $rules['shipping_zip'] = 'required|regex:/^\d{3}-\d{4}$/|size:8';
    ...
    public function messages()
    {
        return [
            ...
            'kana.required' => 'お名前（カナ）は必須です。',
            'kana.regex' => 'お名前（カナ）はカタカナで入力してください。',
            'kana.max' => 'お名前（カナ）は100文字以内で入力してください。',
            ...
            'zip.regex' => '郵便番号は「000-0000」の形式で入力してください。',
            'zip.size' => '郵便番号は8文字で入力してください。',
            ...
            'shipping_kana.required' => '配送先お名前（カナ）は必須です。',
            'shipping_kana.regex' => '配送先お名前（カナ）はカタカナで入力してください。',
            'shipping_kana.max' => '配送先お名前（カナ）は100文字以内で入力してください。',
            'shipping_tel.required' => '配送先電話番号は必須です。',
            'shipping_tel.regex' => '配送先電話番号は数字とハイフンのみで入力してください。',
            'shipping_tel.min' => '配送先電話番号は10文字以上で入力してください。',
            'shipping_tel.max' => '配送先電話番号は15文字以内で入力してください。',
            'shipping_zip.required' => '配送先郵便番号は必須です。',
            'shipping_zip.regex' => '配送先郵便番号は「000-0000」の形式で入力してください。',
            'shipping_zip.size' => '配送先郵便番号は8文字で入力してください。',
