...
<aside class="w-64 flex-shrink-0">
    <div class="bg-green-600 rounded-lg shadow-md p-6">
        ...
        <ul class="space-y-2">
            <li class=""><a href="{{ route('natural-structure') }}" class="block py-2 px-3 text-white hover:bg-green-500 transition">健康のしくみ</a></li>
            <li class=""><a href="{{ route('fermented-foods') }}" class="block py-2 px-3 text-white hover:bg-green-500 transition">発酵食品の役目</a></li>
